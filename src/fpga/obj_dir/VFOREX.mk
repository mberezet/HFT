...
VERILATOR_ROOT = /usr/local/Cellar/verilator/3.862/share/verilator
...
Bellman_TB.o: testbench/Bellman_TB.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VFOREX: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
